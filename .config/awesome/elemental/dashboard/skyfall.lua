...
host_text.font = "CartographCF Regular italic 18"
...
local urls = wibox.widget {
    ...
    create_url("GITHUB", "github.com"),
    create_url("FACEBOOK", "facebook.com"),
    spacing = dpi(10),
    layout = wibox.layout.fixed.vertical,
}
...
local fortune = wibox.widget {
    font = "CartographCF Regular Italic 12",
...
brightness_box:buttons(gears.table.join(
