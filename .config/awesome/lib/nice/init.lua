...
-- ============================================================
-- Colors
local colors = require "lib.nice.colors"
...
-- Shapes
local shapes = require "lib.nice.shapes"
...
-- ============================================================
local table = table
local t = require "lib.nice.table"
table.save = t.save
table.load = t.load
...
local function create_titlebar_title(c)
    ...
    local function update()
        local text_color = is_contrast_acceptable(title_color_light, client_color) and title_color_light
            or title_color_dark
