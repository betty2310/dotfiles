...
local args = {
    api_key = "d823d048acbbb25d8ab24c2d16e6de9c",
...
local current_weather_widget = wibox.widget {
    ...
    update = function(self, weather)
        self:get_children_by_id("icon")[1]:set_image(ICONS_DIR .. icon_map[weather.weather[1].icon] .. icons_extension)
